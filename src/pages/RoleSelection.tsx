...
import { Video, Palette, Shield, ArrowRight, Play } from "lucide-react";
...
const roles = [
  ...
  },
  {
    ...
    description: "Oversee users, projects, disputes, payouts and maintain platform quality and integrity.",
    path: "/admin",
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {roles.map((role, i) => (
            <motion.button
              ...
              className={`glass-card p-8 text-left group cursor-pointer hover:border-primary/40 transition-all duration-300 ${role.glow}`}
            >
              <div className={`w-14 h-14 rounded-2xl ${role.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
